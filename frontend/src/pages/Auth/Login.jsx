...
const Login = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-[#050813]">
      <ToastContainer
        position="top-right"
        autoClose={2000}
        hideProgressBar={false}
      ...
      <div className="w-full lg:w-[40%] flex flex-col justify-center items-center lg:items-start lg:pl-[5rem] px-6 lg:px-0 text-white">
        ...
        <h1 className="text-2xl font-semibold mb-4 text-center lg:text-left">Sign In</h1>
      ...
      <div className="w-full lg:w-[60%] h-[50%] lg:h-full">
